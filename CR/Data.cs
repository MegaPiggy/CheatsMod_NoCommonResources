    ...
    public static class Data
    {
            ...
            set
            {
                if (PlayerData.IsLoaded() && value != launchCodes)
                {
                    if (value)
                    {
                        ...
                        GameObject.FindWithTag("Global")?.GetComponent<KeyInfoPromptController>()?.OnLearnLaunchCodes();
                    }
                    else
                    {
                        ...
                        GameObject.FindWithTag("Global")?.GetComponent<KeyInfoPromptController>()?.OnLaunchCodesEntered();
                    }
        ...
        public static bool eyeCoordinates
        {
            ...
            set
            {
                if (PlayerData.IsLoaded() && Locator.GetShipLogManager() && value != eyeCoordinates)
                {
                    ...
                    GameObject.FindWithTag("Global")?.GetComponent<KeyInfoPromptController>()?._eyeCoordinatesPrompt?.SetVisibility(value);
                }
            }
        }
        ...
        public static bool knowAllRumors
        {
            get
            {
                ...
                return Locator.GetShipLogManager()._factList.TrueForAll(x => !x.IsRumor() || x.IsRevealed());
            }
            set
            {
                if (!Locator.GetShipLogManager())
                ...
                learnFacts(value, false, Locator.GetShipLogManager()._factList.FindAll(x => x.IsRumor()).ToArray());
            }
        }
        ...
        public static bool knowAllFacts
        {
            ...
            set
            {
                ...
                learnFacts(value, false, Locator.GetShipLogManager()._factList.FindAll(x => value || !x.IsRumor()).ToArray());
            }
        }
        ...
        {
            if (Locator.GetShipLogManager() == null) return;
        ...
        public static Tuple<EntryData?, ShipLogEntry> getFactEntry(string factId)
        {
            ...
            EntryData? data = null;
            var library = Locator.GetShipLogManager()._shipLogLibrary;
        ...
        public static void putFactEntry(EntryData data, ShipLogEntry entry)
        {
            ...
            var dictionary = Locator.GetShipLogManager()?._entryDataDict;
            if (dictionary != null)
            {
